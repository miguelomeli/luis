  ...
  ajax.onreadystatechange = function()
  {
     if(this.readyState == 4 && this.status == 200)
     {
	  ...
	  $("#audio").attr("autoplay","true");
          ...
          var derrotero = tojson['dir'].substr(0,tojson['dir'].indexOf('_'));
          console.log(derrotero);
          if(derrotero.indexOf('A02') >= 0)
            $("#horario").attr("src", "src/img/DerroteroT02-"+derrotero+".jpg");
          else if(derrotero.indexOf('A01') >= 0)
            $("#horario").attr("src", "src/img/DerroteroT02-"+derrotero+".jpg");
          else 
            $("#horario").attr("src", "src/img/Derrotero"+derrotero+".jpg");
